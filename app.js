...
function GenerateKarnoMapHTML() {
    ...
    Text += "<th style=\"border-left: none !important; background: #f8f9fa;\"></th>"; 
    for (i = 0; i < KMap.Width; i++) {
        Text += "<th class=\"header-color\" style=\"background: black\">" + BinaryString(BitOrder[i], KMap.XVariables) + "</th>";
    }
    Text += "</tr>";
    for (h = 0; h < KMap.Height; h++) {
        Text += "<tr>";
